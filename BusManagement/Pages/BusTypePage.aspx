...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="d-flex justify-content-end">
        ...
        <asp:Button ID="UpdateBusButton" OnClick="Update_Click" runat="server" Text="Cập Nhật" BackColor="#339933" BorderColor="#339933" CssClass="btn btn-primary ms-2" />
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="?idEdit=<%=busType.BusTypeID %>">Sửa</a>
                    </td>
                </tr>
                <% } %>
            </tbody>
