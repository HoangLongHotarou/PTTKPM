<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusTypePage.aspx.cs" Inherits="BusManagement.Pages.BusTypePage" %>
...
<body>
    ...
    <div>
        <%--<asp:Button ID="Button1" runat="server" Text="Button" OnClick="SelectAll"/>--%>
